  ...
  return (
    <div className="page-enter">
      ...
      <div ref={r2} className="reveal hero-box">
        ...
        <p>DunkFloor is a Lebanese street basketball platform created to represent the real game — not the polished version. The one played on outdoor Mal3ab, in neighborhoods, under pressure, with pride.</p>
      </div>
